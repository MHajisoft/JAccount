...
namespace Account.Service.Migrations
{
    ...
    [Migration("20240726052239_Make_Person_Nullable")]
    partial class Make_Person_Nullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Account.Common.Entity.Food", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateOnly>("CookingDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("Account.Common.Entity.IngredientInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Account.Common.Entity.IngredientInfo", b =>
                {
                    ...
                    b.HasOne("Account.Common.Entity.Food", null)
                        .WithMany("IngredientInfoList")
                        .HasForeignKey("FoodId");

                    b.HasOne("Account.Common.Entity.GeneralType", "Ingredient")
                        .WithMany()
            ...
            modelBuilder.Entity("Account.Common.Entity.Transaction", b =>
                {
                    b.HasOne("Account.Common.Entity.GeneralType", "Account")
                        .WithMany("TransactionAccountTypes")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Account.Common.Entity.GeneralType", "Cost")
                    ...
                    b.HasOne("Account.Common.Entity.GeneralType", "Reason")
            ...
            modelBuilder.Entity("Account.Common.Entity.Food", b =>
                {
                    b.Navigation("IngredientInfoList");
                });
